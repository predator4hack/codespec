...
export class FileService {
    ...
    private validateFileName(name: string): { valid: boolean; sanitized: string; error?: string };
...
export class FeatureTreeProvider implements vscode.TreeDataProvider<FeatureSpecItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<FeatureSpecItem | undefined | null | void>;
